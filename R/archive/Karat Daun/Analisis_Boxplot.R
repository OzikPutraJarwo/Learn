...
# File path
file_path <- "./R/archive/Karat Daun/DATA MENTAH.xlsx"

# Sheet details
sheets <- list(
  list(Sheet = "Boxplot_TebalDaun", xTitle = "Genotypes", yTitle = "Leaf Thickness (ɥm)"),
  list(Sheet = "Boxplot_TebalEpidermis", xTitle = "Genotypes", yTitle = "Epidermis Thickness (ɥm)")
)
